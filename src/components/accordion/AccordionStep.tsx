  ...
  return (
    <div
      className={`
        ...
        relative z-10
        ${isOpen
          ? 'bg-[#EDF4FF] border rounded-[10px] shadow-[0_0_0_1px_rgba(78,47,210,0.10),0_4px_16px_0_rgba(78,47,210,0.06)] z-20'
          : 'bg-white border-y rounded-none'
        }
      `}
    ...
    >
      ...
      <button
        ...
        className={`
          ...
          ${isOpen ? 'bg-transparent' : 'bg-transparent hover:bg-slate-50/80'}
        `}
      >
        {/* Step label + icon + title */}
        <div className="flex-1 flex items-start gap-3 min-w-0">
          <span
            className={`flex-shrink-0 w-5 h-5 flex items-center justify-center transition-colors duration-200 mt-1
          ...
          <div className="min-w-0 flex flex-col">
            <span className="step-label mb-1">Step {stepNumber} of {totalSteps}</span>
            <h2
